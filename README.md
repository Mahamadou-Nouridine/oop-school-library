...
- [📖 Space Travelors' Hub](#-space-travelors-hub)
...
OOP school library is shell-based application for school library management that uses the object oriented programming approach.
...
```sh
  cd my-folder
  git clone https://github.com/Mahamadou-Nouridine/oop-school-library.git
  bundle install
```
